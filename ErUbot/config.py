...
class Osdb(object):
    ...
    UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL", "https://github.com/ErRickow/ubot.git")
...
ALIVE_NAME = os.environ.get("ALIVE_NAME", "Er")
...
class Config(object):
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "eruserbot")
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/c22cea683a0c0dd603fb1.jpg"
    )
    ER_HELP_LOGO = os.environ.get(
        "ER_HELP_LOGO", None
    )
    UB_BLACK_LIST_CHAT = {
